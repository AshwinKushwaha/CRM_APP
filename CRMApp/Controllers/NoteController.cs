...
namespace CRMApp.Controllers
{
    public class NoteController : Controller
    {
        ...
        public IActionResult PagedData(int customerId, int pageIndex)
        {
            var data = _noteService.GetNoteByCustomerId(customerId, pageIndex);

            return PartialView("_NoteList", data);
        }
